...
export const projects: readonly Project[] = [
  {
    ...
    "verified": [
      ...
      "Repository verification is run through pnpm verify"
    ],
    "stack": [
      "Node 22",
      "pnpm",
    ...
    "liveUrl": "https://raedius.online",
    "sourceUrl": null,
    "year": "2026",
    "priority": 1,
    "researchHighlight": false,
    "accent": "#e53935"
  },
  {
    "id": "arkhe",
    ...
    "verified": [
      "Core runtime lives under src/arkhe",
      "Frontier training substrate lives under src/arkhe_frontier",
      "Repository coding organism lives under src/arkhe_coding_frontier",
      "The repository explicitly does not claim independent frontier-model superiority without signed benchmark evidence"
    ],
    "stack": [
      "Python",
      "CLI runtime",
    ...
    "liveUrl": "https://arkhe-live.vercel.app",
    "sourceUrl": null,
    "year": "2026",
    "priority": 3,
    "researchHighlight": false,
  ...
  },
  {
    ...
    "verified": [
      "Workspace packages separate execution engine, prompt engine and shared world rules",
      "The world model includes finite resources, decay, synthesis recipes, zones and economic constraints",
      "The product surface includes agents, beings, chat, governance, marketplace, skills, studio and world routes"
    ],
    "stack": [
      "Next.js",
      "TypeScript",
  ...
  },
  {
    ...
    "verified": [
      "Tauri 2 desktop shell with React and Vite",
      "SQLite local state and Stronghold-backed secret storage",
      "Workflow, scheduling and webhook-trigger paths are represented in the runtime and tests",
      "Provider routing and failover are separate runtime concerns rather than UI-only state"
    ],
    "stack": [
      "Tauri 2",
      "React",
  ...
  },
  {
    ...
    "verified": [
      "Generated, applied and verified are explicit distinct states",
      "Mutation is transactional and verification is independent from model output",
      "Repository intelligence is persisted in a typed graph",
      "Completion is not reported when verification gates fail"
    ],
    "stack": [
      "TypeScript",
      "Node.js",
    ...
    "liveUrl": null,
    "sourceUrl": "https://github.com/dharan1007/codebase--os",
    "year": "2026",
    "priority": 4,
    "researchHighlight": false,
    "accent": "#d7ff68"
  },
  {
    ...
    "verified": [
      "Browser Studio keeps row data local to the browser application path",
      "The local runner targets an existing ordinary SQLite table under a deliberately narrow contract",
      "Source snapshots, reconciliation evidence, fencing and receipts are part of the execution model",
      "Ambiguous conversion and unsafe states fail closed"
    ],
    "stack": [
      "Node.js",
      "CSV streaming",
    ...
    "liveUrl": "https://spool-webmcp.vercel.app/",
    "sourceUrl": null,
    "year": "2026",
    "priority": 5,
    "researchHighlight": false,
  ...
  },
  {
    ...
    "verified": [
      "Durable transaction state and canonical state are separate concerns",
      "Approval is bound to the semantic plan and canonical version",
      "HTTP, MCP and WebMCP surfaces share a canonical tool catalog",
      "Release provenance, locks, diffs, drift and gates are represented in the implementation"
    ],
    "stack": [
      "Node.js",
      "Vercel Functions",
    ...
    "liveUrl": "https://pact-webmcp.vercel.app",
    "sourceUrl": null,
    "year": "2026",
    "priority": null,
    "researchHighlight": false,
  ...
  },
  {
    ...
    "verified": [
      "OpenAlex is the documented scholarly production connector",
      "Connector and browser restrictions remain explicit failure or blocked states",
      "State-changing operations are preview-bound",
      "The same canonical semantics are exposed across UI, API, MCP, WebMCP and CLI"
    ],
    "stack": [
      "JavaScript",
      "OpenAlex",
    ...
    "liveUrl": "https://kata-webmcp.vercel.app/",
    "sourceUrl": null,
    "year": "2026",
    "priority": null,
    "researchHighlight": false,
  ...
  },
  {
    ...
    "verified": [
      "A passing baseline is never imported as a failure",
      "Unsupported or unsafe trials remain unresolved",
      "Final candidates are re-verified against the same failure oracle",
      "The documented claim is bounded 1-minimality over the tested semantic frontier, not global shortest-program optimality"
    ],
    "stack": [
      "Playwright",
      "Node.js",
    ...
    "liveUrl": "https://faultline-webmcp.vercel.app/",
    "sourceUrl": null,
    "year": "2026",
    "priority": 6,
    "researchHighlight": false,
  ...
  },
  {
    ...
    "verified": [
      "Provider-backed observed data is separated from modeled outputs",
      "Forecast outputs include uncertainty and model/prior weighting",
      "Historical validation is point-in-time and baseline-aware",
      "The project does not claim guaranteed trading profitability"
    ],
    "stack": [
      "Python",
    ...
    "liveUrl": "https://stanius.vercel.app",
    "sourceUrl": null,
    "year": "2026",
    "priority": null,
    "researchHighlight": false,
  ...
  },
  {
    ...
    "verified": [
      "Observed, inferred, experimental, degraded, gated and unavailable states are separated",
      "Forecasts expose baseline skill instead of manufacturing fallback confidence",
      "Chronological validation uses later observations only",
      "The project does not execute trades or promise predictive accuracy"
    ],
    "stack": [
      "Python",
      "Market data",
    ...
    "liveUrl": "https://zachitan.vercel.app",
    "sourceUrl": "https://github.com/dharan1007/zachitan-v4",
    "year": "2026",
    "priority": null,
  ...
  },
  {
    ...
    "name": "DAISH",
    "repo": "daish",
    "visibility": "Private · Aphelion product",
    "category": "Public audio intelligence",
    "status": "Beta · 75%",
    ...
    "verified": [
      "Listed on Aphelion's current public platform roadmap",
      "Public Aphelion roadmap marks DAISH at 75% done and in beta",
      "Repository implementation uses a NestJS backend, Next.js PWA, PostgreSQL, Redis and realtime orchestration"
    ],
    "stack": [
      "NestJS",
      "Next.js",
  ...
  },
  {
    ...
    "verified": [
      "Expo / React Native mobile and Next.js web clients exist",
      "Supabase PostgreSQL/Auth/Realtime and Cloudflare Worker/R2 infrastructure are documented",
      "The repository itself warns that a screen, table or type is not evidence of release readiness"
    ],
    "stack": [
      "Expo",
      "React Native",
  ...
  {
    "id": "dvange",
    "name": "Dvange (repo: fuy)",
    "repo": "fuy",
    "visibility": "Public",
    "category": "Social / lifestyle",
    "status": "Broad product codebase",
    ...
    "verified": [
      "Current package and native configuration use the Dvange identity",
      "Web and mobile applications coexist in the same repository",
      "The database model spans substantially more than authentication or a simple feed"
    ],
    "stack": [
      "Next.js",
      "Expo",
    ...
    "liveUrl": null,
    "sourceUrl": "https://github.com/dharan1007/fuy",
    "year": "2025–26",
    "priority": null,
    "researchHighlight": false,
    "accent": "#ff845e"
  },
  {
    ...
    "verified": [
      "Disease prediction, crop-calendar and scheme-discovery services are documented separately",
      "Large image datasets are training/evaluation assets rather than the application architecture",
      "The web layer is separate from the deployable FastAPI services"
    ],
    "stack": [
      "FastAPI",
      "Python",
    ...
    "liveUrl": null,
    "sourceUrl": "https://github.com/dharan1007/agri-ai",
    "year": "2025–26",
    "priority": null,
    "researchHighlight": false,
    "accent": "#7dbe72"
  },
  {
    ...
    "verified": [
      "README documents LightGBM, XGBoost, Random Forest and LSTM model paths",
      "Flutter is used for the mobile application",
      "REST and WebSocket interfaces are part of the documented system"
    ],
    "stack": [
      "Python",
      "Flask",
  ...
  },
  {
    ...
    "verified": [
      "The live app is published through GitHub Pages",
      "Local-first storage is the default product boundary",
      "The repository explicitly avoids medical or guaranteed-outcome claims",
      "Optional Supabase is separate from the core local workflow"
    ],
    "stack": [
      "Vanilla JavaScript",
      "Local storage",
    ...
    "liveUrl": "https://dharan1007.github.io/trakiler/",
    "sourceUrl": "https://github.com/dharan1007/trakiler",
    "year": "2026",
    "priority": null,
    "researchHighlight": false,
    "accent": "#e4ee66"
  },
  {
    ...
    "status": "Production-oriented implementation",
    ...
    "verified": [
      "OTP auth, role onboarding and provider discovery are documented as implemented",
      "Orders, home visits, delivery tasks and signed R2 upload flows are represented",
      "Complaints/admin moderation and provider verification are included",
      "Payment processing is intentionally excluded in the current repository"
    ],
    "stack": [
      "Expo",
      "Next.js",
  ...
  },
  {
    ...
    "verified": [
      ...
      "Supabase PostgreSQL is the documented database",
      "Voice path uses Faster-Whisper and Piper TTS",
      "A Raspberry Pi client is part of the repository structure"
    ],
    "stack": [
      "Python 3.13",
      "FastAPI",
  ...
  },
  {
    ...
    "verified": [
      "Listed by Aphelion in the Core Computing layer",
      "Public Aphelion roadmap currently marks Nexus at 85% done and in beta",
      "Aphelion states that Nexus's computation model directly informs Dot OS"
    ],
    "stack": [
      "Execution architecture",
      "Adaptive workloads",
      "Recursive intelligence",
      "Aphelion core computing"
    ],
    "liveUrl": "https://www.aphelion.life/",
    "sourceUrl": null,
    "year": "2026",
    "priority": 11,
    "researchHighlight": false,
  ...
  {
    "id": "resume-system",
    "name": "Resume Optimization System",
    "repo": "7th-gear",
    "visibility": "Private",
    "category": "Career tooling",
    ...
    "verified": [
      "Resume and job-description parsing are documented",
      "CLI commands cover optimize, analyze, match and batch workflows",
      "The system explicitly states that optimization should not fabricate experience"
    ],
    "stack": [
      "Python",
      "spaCy",
  ...
  },
  {
    ...
    "repo": "nishtha",
    "visibility": "Private",
    "category": "Repository recovery",
    "status": "Broken superproject metadata",
    ...
    "verified": [
      "Two Gitlink entries are present",
      "The .gitmodules file needed to identify remotes is missing",
      "The repository documentation intentionally refuses to invent the application architecture"
    ],
    "stack": [
  ...
  {
    "id": "line-connect-grow",
    "name": "Line Connect Grow",
    "repo": "line-connect-grow",
    "visibility": "Private",
    "category": "Web scaffold",
    "status": "Lovable scaffold",
    ...
    "verified": [
      "Vite, TypeScript and React are documented",
      "shadcn-ui and Tailwind are part of the documented stack",
      "The README is primarily a generated Lovable project guide"
    ],
    "stack": [
      "Vite",
      "TypeScript",
  ...
  },
  {
    ...
    "verified": [
      "Expo 54 / React Native 0.81.4 starter code is present",
      "Current primary routes are starter screens",
      "Supabase configuration is preparatory rather than evidence of a working integration"
    ],
    "stack": [
      "Expo 54",
      "React Native",
  ...
  },
  {
    ...
    "verified": [
      "Expo starter documentation is present",
      "Product-specific architecture is not documented in the root README"
    ],
    "stack": [
      "Expo",
      "React Native"
  ...
  {
    "id": "maleu-reel-studio",
    "name": "Maleu Reel Studio",
    "repo": "maleu-reel-studio",
    "visibility": "Private",
    "category": "Generative media",
    "status": "Limited repository documentation",
    ...
    "verified": [
      "Repository exists",
      "Root README is not available in the current branch"
    ],
    "stack": [],
    "liveUrl": null,
    "sourceUrl": null,
  ...
  },
  {
    ...
    "verified": [
      ...
      "Repository-backed implementation details remain private"
    ],
    "stack": [],
    "liveUrl": null,
    "sourceUrl": null,
  ...
  },
  {
    ...
    "verified": [
      "Listed by Aphelion in the Core Computing layer",
      "Public Aphelion roadmap currently marks Dot OS at 20% done",
      "Aphelion positions Nexus directly below Dot OS in the system architecture"
    ],
    "stack": [
  ...
  },
  {
    ...
    "verified": [
      "Repository exists",
      "Root README does not document the application"
    ],
    "stack": [],
    "liveUrl": null,
    "sourceUrl": null,
  ...
  },
  {
    ...
    "repo": "agri-farm",
    "visibility": "Private",
    "category": "Agriculture repository",
    ...
    "verified": [
      "Repository exists",
      "Readable root documentation is insufficient"
    ],
    "stack": [],
    "liveUrl": null,
    "sourceUrl": null,
